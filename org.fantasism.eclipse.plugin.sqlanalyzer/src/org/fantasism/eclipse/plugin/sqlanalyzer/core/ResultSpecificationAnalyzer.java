...
public class ResultSpecificationAnalyzer {
    ...
    public <T> SelectColumn<T> analyze(T owner, QueryResultSpecification result) {
    ...
    private <T> SelectColumn<T> analyzeColumn(T owner, ResultColumn result) {
    ...
    private <T> SelectColumn<T> analyzeTableAllColumn(T owner, ResultTableAllColumns result) {
